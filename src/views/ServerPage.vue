...
export default {
    ...
    async created() {
      ...
      const res = await fetch(
          "http://localhost:5000/"+this.$route.params.id+"/server/tables",
          {
            method: "GET",
            credentials: 'include',
          }
    ...
    methods: {
        ...
        async checkInorOut(checkIn) {
            ...
            const res = await fetch("http://localhost:5000/" + this.$route.params.id + "/server/" + isCheckedIn, {
              method: "POST",
              headers: {
      ...
      async getTablesAssignedArray(){
        const res = await fetch(
            "http://localhost:5000/"+this.$route.params.id+"/server/"+this.username,
            {
              method: "GET",
              credentials: 'include',
            }
      ...
      async getAllRequests() {
        const res = await fetch(
            "http://localhost:5000/"+this.$route.params.id+"/server/requests",
            {
              method: "GET",
              credentials: 'include',
            }
      ...
      async getServerRequests(){
        const res = await fetch(
            "http://localhost:5000/"+this.$route.params.id+"/server/serverRequests/"+this.username,
            {
              method: "GET",
              credentials: 'include',
            }
